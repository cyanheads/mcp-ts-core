/**
 * @fileoverview Stateful SSE resumability (#215) over the HTTP transport, driven
 * through Hono's `.request()` with a real `McpServer` behind the session store.
 * @module tests/integration/http-transport.int.test
 */
